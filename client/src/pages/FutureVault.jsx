...
// import { 
//   Clock, Calendar, Plus, Trash2, ArrowLeft, 
//   Shield, Mail, User, ChevronRight, Loader2,
//   AlertCircle, CheckCircle2, Send, Info, Archive
// } from 'lucide-react';
...
//     try {
//       setLoading(true);
//       const response = await authFetch('/api/vaults/future/slots');
...
//       const data = await response.json();
//       if (data.success) {
//         // If we have email and date, schedule it immediately
//         if (newSlot.recipientEmail && newSlot.scheduledDate) {
...
//         setNewSlot({ name: '', recipientEmail: '', scheduledDate: '' });
//         fetchSlots();
//       } else {
...
//         method: 'DELETE',
//         body: JSON.stringify({ vaultType: 'future' }),
//       });
//       const data = await response.json();
//       if (data.success) {
//         fetchSlots();
...
//         <p className="text-slate-500 font-medium">Opening Future Vault...</p>
//       </div>
//     </div>
//   );
...
//               <Clock size={18} />
//             </div>
//             <span className="font-bold text-slate-900">Future Vault</span>
//           </div>
//           <Button 
//             onClick={() => setShowAddSlot(true)}
//             className="bg-blue-600 hover:bg-blue-700 text-white font-bold shadow-lg shadow-blue-100"
//           >
...
//         <div className="mb-10">
//           <h1 className="text-3xl font-bold text-slate-900">Long-term Memories</h1>
//           <p className="text-slate-500 mt-2">Schedule memories to be delivered up to 9 months in advance.</p>
//         </div>
...
//                   <CardTitle className="text-lg">Create New Memory Slot</CardTitle>
//                   <CardDescription>Set the recipient and delivery date</CardDescription>
//                 </CardHeader>
//                 <CardContent className="p-6">
//                   <form onSubmit={handleAddSlot} className="grid grid-cols-1 md:grid-cols-3 gap-6">
//                     <div className="space-y-2">
//                       <label className="text-sm font-medium text-slate-700 ml-1">Slot Name</label>
//                       <Input 
...
//                     </div>
//                     <div className="space-y-2">
//                       <label className="text-sm font-medium text-slate-700 ml-1">Delivery Date (Optional)</label>
//                       <Input 
//                         type="date"
...
//                         Cancel
//                       </Button>
//                       <Button type="submit" disabled={submitting} className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-8">
...
//                   <div className={`h-1.5 w-full ${slot.delivered ? 'bg-emerald-500' : 'bg-blue-500'}`}></div>
//                   <CardHeader className="pb-2">
//                     <div className="flex items-center justify-between">
//                       <div className={`p-2 rounded-lg ${slot.delivered ? 'bg-emerald-50 text-emerald-600' : 'bg-blue-50 text-blue-600'}`}>
//                         {slot.delivered ? <CheckCircle2 size={18} /> : <Clock size={18} />}
//                       </div>
//                       <Button 
//                         variant="ghost" 
//                         size="sm" 
...
//                         <Calendar size={14} />
//                         <span>{slot.scheduledDate ? new Date(slot.scheduledDate).toLocaleDateString() : 'Not scheduled'}</span>
//                       </div>
//                       <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${
//                         slot.delivered ? 'bg-emerald-100 text-emerald-700' : 'bg-blue-100 text-blue-700'
//                       }`}>
//                         {slot.delivered ? 'Delivered' : (slot.scheduledDate ? 'Scheduled' : 'Draft')}
//                       </span>
//                     </div>
//                     <Button 
//                       variant="outline" 
//                       className="w-full mt-6 border-slate-200 text-slate-600 hover:bg-slate-50 hover:text-blue-600 group/btn"
...
//                 <Archive size={40} />
//               </div>
//               <h3 className="text-xl font-bold text-slate-900">No slots yet</h3>
//               <p className="text-slate-500 mt-2 max-w-xs mx-auto">
//                 Start by creating your first memory slot to schedule for the future.
//               </p>
//               <Button 
//                 onClick={() => setShowAddSlot(true)}
...
//         {/* Info Card */}
//         <Card className="mt-16 border-none shadow-sm bg-blue-50/50 border border-blue-100">
//           <CardContent className="p-6 flex items-start gap-4">
//             <div className="p-2 bg-blue-100 rounded-lg text-blue-600">
//               <Info size={20} />
//             </div>
//             <div>
//               <h4 className="font-bold text-blue-900">About Future Vault</h4>
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-between items-center mb-4">
            <Button onClick={() => navigate('/dashboard')} variant="outline" className="text-slate-500 hover:text-slate-900 font-bold">
              <ArrowLeft size={20} className="mr-2" /> Back to Dashboard
            </Button>
            <Button 
              variant="ghost" 
